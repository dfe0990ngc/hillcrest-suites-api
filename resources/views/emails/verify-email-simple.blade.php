                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 8px;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px; font-family: Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #333333;">
                            ...
                            <h2 style="margin: 0 0 20px 0; font-size: 28px; color: #008ea2; font-weight: bold;">Welcome to {{ config('app.name') }}!</h2>
                            
                            <p style="margin: 0 0 20px 0;">Hello {{ $user->name ?? 'there' }},</p>
                            
                            <p style="margin: 0 0 30px 0;">Thank you for registering with {{ config('app.name') }}! To complete your registration and start using your <strong>account</strong>, please verify your email address by clicking the button below.</p>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                            <tr>
                                                <td align="center" style="border-radius: 6px; background-color: #008ea2;">
                                                    <a href="{{ $verificationUrl }}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold;">
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        <p style="margin: 0; font-size: 14px; color: #333333;">
                                            ...
                                            This verification link will expire in {{ $expireMinutes }} minutes for your security.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            
                            <h3 style="margin: 30px 0 15px 0; font-size: 20px; color: #008ea2;">What's Next?</h3>
                            
                            <p style="margin: 0 0 10px 0;">Once your email is verified, you'll be able to:</p>
                            
                            <ul style="margin: 0 0 25px 0; padding-left: 20px;">
                                <li style="margin-bottom: 8px;">✅ Access your personalized dashboard</li>
                                <li style="margin-bottom: 8px;">📊 View your booking information</li>
                                <li style="margin-bottom: 8px;">🔔 Receive notifications</li>
                            </ul>
                            
                            <h3 style="margin: 30px 0 15px 0; font-size: 20px; color: #008ea2;">Need Help?</h3>
                            
                            <p style="margin: 0 0 15px 0;">If you're having trouble clicking the "Verify Email Address" button, copy and paste the URL below into your web browser:</p>
                            ...
                            <p style="margin: 0 0 25px 0;">If you did not create an account with us, no further action is required.</p>
